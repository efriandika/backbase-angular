...
/**
 * Finds an element inside the Component by the given `data-selector` attribute.
 * Throws an error if no element was found.
 *
 * @param fixture Component fixture
 * @param selector
...
export function findEl<T>(fixture: ComponentFixture<T>, selector: string): DebugElement {
  return queryByCss<T>(fixture, selector);
}

/**
 * Finds all elements with the given `data-selector` attribute.
 *
 * @param fixture Component fixture
 * @param selector
 */
...
/**
 * Gets the text content of an element with the given `data-selector` attribute.
 *
 * @param fixture Component fixture
 * @param selector
 */
...
/**
 * Expects that the element with the given `data-selector` attribute
...
/**
 * Sets the value of a form field with the given `data-selector` attribute.
 *
 * @param fixture Component fixture
 * @param selector
 * @param value Form field value
...
export function checkField<T>(
  ...
  const { nativeElement } = findEl(fixture, selector);
...
/**
 * Emulates a left click on the element with the given `data-selector` attribute.
 *
 * @param fixture Component fixture
 * @param selected
 */
export function click<T>(fixture: ComponentFixture<T>, selected: string): void {
  const element = findEl(fixture, selected);
 ...
 * When finding other elements, use `findEl` / `findEls` and `data-selector` attributes.
 *
